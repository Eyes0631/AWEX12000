...
using ProVLib;
using System;
using System.Diagnostics; //Gary 20240522
...
namespace PaeLibProVSDKEx
{
    ...
    public class Cylinder : IDisposable
    {
        ...
        private Stopwatch sw_ActionTime;
        private System.Timers.Timer MyTimer;
        private bool bSetOn = false;
        private bool bSetOff = false;
        ...
        public Cylinder(OutBit obOn, OutBit obOff, InBit ibOn, InBit ibOff, string CyName = "NoName")
        {
            m_Simulation = false;
            OB_On = obOn;
            OB_Off = obOff;
        ...
        /// <param name="ibOn">The ib on.</param>
        /// <param name="ibOff">The ib off.</param>
        public Cylinder(OutBit obOn, InBit ibOn, InBit ibOff, string CyName = "NoName")
        {
            OB_On = obOn;
            OB_Off = null;
            DI_On = new DigitalInput(ibOn);
        ...
        void MyTimer_Elapsed(object sender, System.Timers.ElapsedEventArgs e)
        {
            ...
            if (bSetOn)
            {
                ...
                {
                    sw_ActionTime.Stop();
                    if (OnCylinderChange != null)
                    {
                        OnCylinderChange(MyName, sw_ActionTime.ElapsedMilliseconds.ToString());
                    }
                    bSetOn = false;
                }
            }
        ...
        public delegate void DelGetCylinderChangeTime(string CyName, string ActionTime);      //Gary 20240522

        public DelGetCylinderChangeTime OnCylinderChange;       //Gary 20240522
        #endregion 公用屬性

...
namespace ProVGEMProcessFSM
{
    ...
    public class ProVProcessFSM : PassiveStateMachine<StateID, EventID, EventArgs>, IDisposable
    {
        ...
        public ProVProcessFSM()
        {
            ...
            //PM
            //+ By Max, v4.0.1.12
            AddTransition(StateID.ALARM, EventID.EVT_PMSET, StateID.PM);
            AddTransition(StateID.IDLE, EventID.EVT_PMSET, StateID.PM);
            AddTransition(StateID.PAUSE, EventID.EVT_PMSET, StateID.PM);
            AddTransition(StateID.PM, EventID.EVT_ABORT, StateID.IDLE);

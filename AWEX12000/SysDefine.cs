...
namespace AWEX12000
{
    ...
    public class SYSPara
    {
        ...
        public static UInt64 SingleRunTM; //機台單次運行時間
        ...
        public static byte OEERPFrom = 0;
        public static string OEERPType = string.Empty;
                ...
                if (idx == 1) //SECS
                {
                    switch (mSysState)
                    {
                        ...
                        case StateMode.SM_IDLE:
                            {
                                ...
                                {
                                    //+ By Max, v4.0.1.12
                                    if (mPreRunMode == RunModeDT.MAINTENANCE)
                                    {
                        ...
                        case StateMode.SM_MAINTENANCE_RUN:
                            {
                                FormSet.mGemF.ChangeProcessState(ProVGEMProcessFSM.EventID.EVT_PMSET);
                            }
                            break;
                    }
                }
        ...
        public static bool 安全門偵測開關關閉 = false;
        public static int OrgSysSpeedRate = 100; //機台原始速率

...
namespace PaeLibBibExchangerModule
{
    ...
    public enum BEMAlarmCode
    {
        ...
        ArmBemTransferRackLidDetectErrorCT = 66,

        //Alarm : 退板至推車流程偵測到RACK開蓋異常，請確認是否開蓋
        ArmBemTransferRackLidDetectErrorTC = 67,

        //Alarm : 送板至主機流程偵測到平台內開蓋異常，請確認是否卡板
        ArmBemTransferTrackLidDetectErrorTS = 68,

        //Alarm : 從主機收板流程偵測到平台內開蓋異常，請確認是否卡板
        ArmBemTransferTrackLidDetectErrorST = 69,

...
namespace PD2_SDK
{
    public partial class ElevatorBaseModule
    {
        ...
        public virtual void SetSpeed()
        {
            ...
            {
                if (iMotorZ_ACC_MULTIPLE > 10 || iMotorZ_ACC_MULTIPLE < 0)
                {
                    iMotorZ_ACC_MULTIPLE = 1;
                } if (iMotorZ_DEC_MULTIPLE > 10 || iMotorZ_DEC_MULTIPLE < 0)
                {
                    iMotorZ_DEC_MULTIPLE = 1;
                }
                IO_MOTOR.MO_AxisZ.SetSpeed(iMotorZ_Speed);
                IO_MOTOR.MO_AxisZ.SetAcceleration(iMotorZ_Speed * iMotorZ_ACC_MULTIPLE);
                IO_MOTOR.MO_AxisZ.SetDeceleration(iMotorZ_Speed * iMotorZ_DEC_MULTIPLE);
            }
        }

...
namespace CommonObj
{
    ...
    public partial class CylinderEx2 : UserControl
    {
        ...
        private const int FormSizeY_Open = 320;
        ...
        public bool Simulation
        {
            get
            {
                return MyCylinder_1.Simulation && MyCylinder_1.Simulation;
            }
            set
            {
                MyCylinder_1.Simulation = value;
                MyCylinder_2.Simulation = value;
            }
        }
        ...
        private void timer1_Tick(object sender, EventArgs e)
        {
            ...
            if (MyCylinder_1 != null && MyCylinder_2 != null)
            {
                ...
                if (bManual)
                {
                    ...
                    ledLabel_On_2.Value = MyCylinder_2.OnSensorValue;
                    ledLabel_Off_2.Value = MyCylinder_2.OffSensorValue;
                }
            }

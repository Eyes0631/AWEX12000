...
namespace AWEX12000
{
    ...
    public enum TableCode { REAL = 0, OPTION, PACKAGE, PRELOADPACKAGE, ECID };
    // HOST遠端指令
    ...
    public partial class ProVGemF : Form
    {
        ...
        /// <summary>
        /// Handler端透過此函式要求ProVGEM回報量測事件給Host
        /// </summary>
        /// <param name="EventName">定義在proVSECS.xls中的事件名稱</param>
        public void MeasurementEventReport(String EventName)
        {
            if ((CurCommState == ProVGEMCommFSM.StateID.COMMUNICATING || SECSEngine.SpoolActive) &&
                (ControlState == ProVGEMControlFSM.StateID.ONLINELOCAL ||
                ControlState == ProVGEMControlFSM.StateID.ONLINEREMOTE)
                )
            {
                ...
                {
                    List<byte> sb = report.EncodeEventReport();
                    SECSEngine.SendHSMSMessage(6, 3, true, sb.ToArray());
                }
            }
        }
        ...
        /// </summary>
        /// <param name="EventName">定義在proVSECS.xls中的事件名稱</param>
        public void MeasurementEventReport(ushort EventID)
        {
            if ((CurCommState == ProVGEMCommFSM.StateID.COMMUNICATING || SECSEngine.SpoolActive) &&
                (ControlState == ProVGEMControlFSM.StateID.ONLINELOCAL ||
                ControlState == ProVGEMControlFSM.StateID.ONLINEREMOTE)
        ...
        public void AlarmReport(ArmMtrl arm, bool isSet = true)
        {
                ...
                )
            {
                ...
                if (almData != null)
                {
                    ...
                    if (almData.ALED == 0x80) //if enabled
                    {
                        if (isSet)
                        {
        ...
        {
            //通訊Log物件的建立
            commLogger = new Logger(SECSEngine, listBox1);
            ...
            try
            {
                ...
                //+ By Max, Create AlarmList.xls
                ScanAndCreateAlarmList(SYSPara.Alarm.AlarmTable);
            }
            catch (Exception ex)
            {
        ...
        void ProcFSM_TransitionCompleted(object sender, Sanford.StateMachineToolkit.TransitionCompletedEventArgs<ProVGEMProcessFSM.StateID, ProVGEMProcessFSM.EventID, EventArgs> e)
        {
            ...
            switch (e.TargetStateID)
            {
                ...
                case ProVGEMProcessFSM.StateID.HOME:
                    ...
                    break;
                case ProVGEMProcessFSM.StateID.PM:
                    {
                        lblIdle.BackColor = Color.White;
                        lblSetup.BackColor = Color.White;
                        lblInitial.BackColor = Color.White;
                        ...
                        lblAlarm.BackColor = Color.White;
                        lblHome.BackColor = Color.White;
                        lblPM.BackColor = Color.GreenYellow;
                    }
                    break;
            }
        }
        ...
        private long proVSECSEngine1_SECSEvent(EVENTID EvtID, EventData pEventData)
        {
            switch (EvtID)
            {
                #region Event Connected
                case EVENTID.EVENT_CONNECTED:
                    {
                ...
                case EVENTID.EVENT_DISCONNECTED:
                    {
                ...
                case EVENTID.EVENT_RECV_MSG:
                                                ...
                                                default:
                                                    {
                                                        if (pEventData.W_Bit)
                                                        {
                                                            List<byte> sb = new List<byte>();
                                                            sb.Clear();
                                                            SECSEngine.ReplyHSMSMessage(pEventData.S, 0, false, sb.ToArray(), pEventData.ulSystemBytes);
                    ...
                    break;
                case EVENTID.EVENT_REPLY_TIMEOUT:
                    {
        ...
        private void ProcessSType_1(EventData pEventData)
        {
                ...
                case 1: //S1F1 Are You There Request
                    {
                        if (CurCommState == ProVGEMCommFSM.StateID.COMMUNICATING)
                        {
                            ...
                            SECSData = QueryValueEventHandler("SOFTREV", "A", TableCode.REAL);
                            SECSEngine.EncodeDataItem(ref sb, SECSData);
                            SECSEngine.ReplyHSMSMessage(1, 2, false, sb.ToArray(), pEventData.ulSystemBytes);
                        }
                    }
                    break;
                ...
                case 3: //Selected Equipment Status Request
                    {
                        if (CurCommState == ProVGEMCommFSM.StateID.COMMUNICATING)
                        {
                            ...
                            SECSEngine.ReplyHSMSMessage(1, 4, false, sb.ToArray(), pEventData.ulSystemBytes);
                        }
                    }
                    break;
                case 11: //S1F11 Status Variable Namelist Request
                    {
                        if (CurCommState == ProVGEMCommFSM.StateID.COMMUNICATING)
                        {
                            ...
                            SECSEngine.ReplyHSMSMessage(1, 12, false, sb.ToArray(), pEventData.ulSystemBytes);
                        }
                    }
                    break;
                case 13:
        ...
        private void ProcessSType_2(EventData pEventData)
        {
            switch (pEventData.F)
            {
                case 13: //S2F13 Equipment Constant Request
                    {
                        if (CurCommState == ProVGEMCommFSM.StateID.COMMUNICATING)
                        {
                            ...
                            SECSEngine.ReplyHSMSMessage(2, 14, false, sb.ToArray(), pEventData.ulSystemBytes);
                        }
                    }
                    break;
                case 15: //S2F15 New Equipment Constant Send
                    {
                        if (CurCommState == ProVGEMCommFSM.StateID.COMMUNICATING)
                        {
                            ...
                            if (iRet != 0)
                            {
                                ...
                                SECSEngine.ReplyHSMSMessage(2, 16, false, sb.ToArray(), pEventData.ulSystemBytes);
                            }
                            else
                            {
                ...
                case 17: //S2F17 Date and Time Request
                    {
                        if (CurCommState == ProVGEMCommFSM.StateID.COMMUNICATING)
                        {
                            ...
                            SECSEngine.EncodeDataItem(ref sb, SECSData);
                            SECSEngine.ReplyHSMSMessage(2, 18, false, sb.ToArray(), pEventData.ulSystemBytes);
                        }
                    }
                    break;
                case 23: //S2F23 Trace Initialize Send
                    {
                        if (CurCommState == ProVGEMCommFSM.StateID.COMMUNICATING)
                        {
                            ...
                            SECSEngine.ReplyHSMSMessage(2, 24, false, sb.ToArray(), pEventData.ulSystemBytes);
                        }
                    }
                    break;
                case 29: //S2F29 Equipment Constane Namelist Request
                    {
                        if (CurCommState == ProVGEMCommFSM.StateID.COMMUNICATING)
                        {
                            ...
                            SECSEngine.ReplyHSMSMessage(2, 30, false, sb.ToArray(), pEventData.ulSystemBytes);
                        }
                    }
                    break;
                case 31: //S2F31 Date and Time Set Request
                    {
                        if (CurCommState == ProVGEMCommFSM.StateID.COMMUNICATING)
                        {
                            ...
                            if (strTime.Length == 12)
                            {
                                ...
                                sysTime.wYear = Convert.ToUInt16(strTime.Substring(0, 2));
                                sysTime.wMonth = Convert.ToUInt16(strTime.Substring(2, 2));
                                sysTime.wDay = Convert.ToUInt16(strTime.Substring(4, 2));
                                sysTime.wHour = Convert.ToUInt16(strTime.Substring(6, 2));
                                sysTime.wMinute = Convert.ToUInt16(strTime.Substring(8, 2));
                                sysTime.wSecond = Convert.ToUInt16(strTime.Substring(10, 2));
                            ...
                            if (strTime.Length == 16)
                            {
                                ...
                                sysTime.wMiliseconds = Convert.ToUInt16(strTime.Substring(14, 2));
                                SetLocalTime(ref sysTime);
                            }
                            SECS_BINARY TACK = new SECS_BINARY(0);
                            SECSEngine.EncodeDataItem(ref sb, TACK);
                            SECSEngine.ReplyHSMSMessage(2, 32, false, sb.ToArray(), pEventData.ulSystemBytes);
                        }
                    }
                    break;
                case 33: //S2F33 Define Report
                    {
                        if (CurCommState == ProVGEMCommFSM.StateID.COMMUNICATING)
                        {
                            ...
                            for (int i = 0; i < La; ++i)
                            {
                                ...
                                if (rpt != null)
                                {
                                    ...
                                    for (int j = 0; j < Lb; ++j) //VIDs
                                    {
                                        ...
                                        lAddress = SECSEngine.DecodeDataItem(pEventData.RawData, lAddress, ref u2Data);
                                        VIDData vid = GetVID(u2Data.Data);
                                        if(vid != null)
                                            rpt.AddVID(vid); //Re-Create VID List with this Report
                                    }
                                }
                            }
                            ...
                            SECSEngine.ReplyHSMSMessage(2, 34, false, sb.ToArray(), pEventData.ulSystemBytes);
                        }
                    }
                    break;
                case 35: //S2F35 Link Event Report
                    {
                        if (CurCommState == ProVGEMCommFSM.StateID.COMMUNICATING)
                        {
                            ...
                            List<byte> sb = new List<byte>();
                            SECSEngine.EncodeDataItem(ref sb, binaryData);
                            SECSEngine.ReplyHSMSMessage(2, 36, false, sb.ToArray(), pEventData.ulSystemBytes);
                        }
                    }
                    break;
                case 37: //S2F37 Enable/Disable Event Report
                    {
                        if (CurCommState == ProVGEMCommFSM.StateID.COMMUNICATING)
                        {
                            ...
                            SECSEngine.ReplyHSMSMessage(2, 38, false, sb.ToArray(), pEventData.ulSystemBytes);
                        }
                    }
                    break;
                                ...
                                case "INITIAL":
                                    {
                                        ...
                                        if (OnDataExchangeEvent != null)
                                        {
                                            ...
                                            SECSEngine.EncodeDataItem(ref sb, listData);
                                            SECSEngine.ReplyHSMSMessage(2, 42, false, sb.ToArray(), pEventData.ulSystemBytes);
                ...
                case 43: //S2F43 Reset Spooling Streams and Functions
                    {
                        ...
                        SECSEngine.ReplyHSMSMessage(2, 44, false, sb.ToArray(), pEventData.ulSystemBytes);
                    }
                    break;
                case 45:
                    {
                        ...
                        SECSEngine.EncodeDataItem(ref sb, lstData);
                        SECSEngine.ReplyHSMSMessage(2, 46, false, sb.ToArray(), pEventData.ulSystemBytes);
                    }
                    break;
                case 47: //S2F47, Variable Limit Attribute Request
                    {
                        ...
                        SECSEngine.ReplyHSMSMessage(2, 48, false, sb.ToArray(), pEventData.ulSystemBytes);
                    }
                    break;
                #region S9,F5 Unrecognized Function Type
                default:
        ...
        private void ProcessSType_5(EventData pEventData)
        {
            switch (pEventData.F) //Function
            {
                case 3: //S5F3 Enable/Disable Alarm Send
                    {
                        if (CurCommState == ProVGEMCommFSM.StateID.COMMUNICATING)
                        {
                            ...
                            SECSEngine.ReplyHSMSMessage(5, 4, false, sb.ToArray(), pEventData.ulSystemBytes);
                        }
                    }
                    break;
                case 5: //S5F5 List Alarm Request
                    {
                        if (CurCommState == ProVGEMCommFSM.StateID.COMMUNICATING)
                        {
                            ...
                            SECSEngine.ReplyHSMSMessage(5, 6, false, sbsend.ToArray(), pEventData.ulSystemBytes);
                        }
                    }
                    break;
                case 7: //S5F7 List Enabled Alarm Request
                    {
                        if (CurCommState == ProVGEMCommFSM.StateID.COMMUNICATING)
                        {
                            ...
                            List<byte> sbsend = new List<byte>();
                            List<ALMData> lstALMData = ArmList.Where(x => x.ALED == 0x80).ToList();
                            ...
                            SECSEngine.ReplyHSMSMessage(5, 8, false, sbsend.ToArray(), pEventData.ulSystemBytes);
                        }
                    }
                    break;
                #region S9,F5 Unrecognized Function Type
        ...
        private void ProcessSType_6(EventData pEventData)
        {
            switch (pEventData.F) //Function
            {
                case 11: //S6F11
                ...
                case 15:  //S6F15 Host Request an Event Report
                    {
                        if (CurCommState == ProVGEMCommFSM.StateID.COMMUNICATING)
                        {
                            ...
                            {
                                List<byte> sb = report.EncodeEventReport();
                                SECSEngine.ReplyHSMSMessage(6, 16, false, sb.ToArray(), pEventData.ulSystemBytes);
                            }
                        }
                    }
                    break;
                case 17:  //S6F17 Host Request an Event Report with Annotated
                    {
                        if (CurCommState == ProVGEMCommFSM.StateID.COMMUNICATING)
                        {
                            ...
                            if (report != null)
                            {
                                ...
                                SECSEngine.ReplyHSMSMessage(6, 18, false, sb.ToArray(), pEventData.ulSystemBytes);
                            }
                        }
                    }
                    break;
                case 19:  //S6F19 Individual Report Request
                    {
                        if (CurCommState == ProVGEMCommFSM.StateID.COMMUNICATING)
                        {
                            ...
                            SECSEngine.ReplyHSMSMessage(6, 20, false, sb.ToArray(), pEventData.ulSystemBytes);
                        }
                    }
                    break;
                case 23: //S6F23 Request Spooled Data
                    {
                        ...
                        SECSEngine.ReplyHSMSMessage(6, 24, false, sb.ToArray(), pEventData.ulSystemBytes);
        ...
        private void ProcessSType_7(EventData pEventData)
        {
            switch (pEventData.F)
            {
                case 1://S7F1 Process Program Load Inquire
                    {
                        ...
                        if (OnDataExchangeEvent != null)
                        {
                            ...
                            sb.Clear();
                            SECSEngine.EncodeDataItem(ref sb, listData);
                            SECSEngine.ReplyHSMSMessage(7, 2, false, sb.ToArray(), pEventData.ulSystemBytes);
                        }
                    }
                    break;
                case 2://S7F2 Process Program Load Grant
                    {
                        if (OnDataExchangeEvent != null)
                        {
                            ...
                            if (binData.Data == 0) //可以將LoadInquirePPID對應的Package內容往Host傳
                            {
                                ...
                                //SECS_ASCII ascData = new SECS_ASCII();
                                //lAddress = SECSEngine.DecodeDataItem(pEventData.RawData, lAddress, ref ascData);
                                String PPID = LoadInquirePPID;

                                ExchangeData data = new ExchangeData();
                                data.Code = TableCode.REAL;
                                data.DataName = "PPACTION";
                                data.ParamMap.SetParameter("EXISTPPID", PPID);
                                data = OnDataExchangeEvent(EventType.QUERY, data);
                                int iRet = data.RetData.ToInt();
                                ...
                                else
                                {
                                    ...
                                    if (iRet == 0)
                                    {
                                        ...
                                        else
                                        {
                                            ...
                                            SECS_LIST lstData = new SECS_LIST(2);
                                            SECSEngine.EncodeDataItem(ref sb, lstData);
                                            SECS_ASCII ascData = new SECS_ASCII(PPID);
                                            SECSEngine.EncodeDataItem(ref sb, ascData);
                ...
                case 3: //S7F3 Process Program Send
                    {
                        if (OnDataExchangeEvent != null)
                        {
                            ...
                            SECS_LIST lstData = new SECS_LIST(0);
                            SECSEngine.EncodeDataItem(ref sb, lstData);
                            SECSEngine.ReplyHSMSMessage(7, 4, false, sb.ToArray(), pEventData.ulSystemBytes);
                        }
                    }
                    break;
                case 5: //S7F5 Process Program Request  H -> E
                    {
                        if (OnDataExchangeEvent != null)
                        {
                            ...
                            if (iRet == 0) //Not Existed
                            {
                                ...
                                SECS_LIST lstData = new SECS_LIST(0);
                                SECSEngine.EncodeDataItem(ref sb, lstData);
                                SECSEngine.ReplyHSMSMessage(7, 6, false, sb.ToArray(), pEventData.ulSystemBytes);
                ...
                case 17://S7F17 Delete Process Program Send
                    {
                        if (OnDataExchangeEvent != null)
                        {
                            ...
                            else
                            {
                                ...
                                SECSEngine.EncodeDataItem(ref sb, bData);
                                SECSEngine.ReplyHSMSMessage(7, 18, false, sb.ToArray(), pEventData.ulSystemBytes);
                            }
                ...
                case 19: //S7F19 Current EPPD Request
                    {
                        if (OnDataExchangeEvent != null)
                        {
                            ...
                            SECSEngine.ReplyHSMSMessage(7, 20, false, sb.ToArray(), pEventData.ulSystemBytes);
                        }
                    }
                    break;
                case 23: //S7F23 Fortmated Process Program Send
                    {
                        if (OnDataExchangeEvent != null)
                        {
                            int lAddress = 0;
                            ...
                            SECS_LIST listData = new SECS_LIST();
                            lAddress = SECSEngine.DecodeDataItem(pEventData.RawData, lAddress, ref listData);
                            SECS_ASCII PPData = new SECS_ASCII();
                            lAddress = SECSEngine.DecodeDataItem(pEventData.RawData, lAddress, ref PPData); //PPID
                            SECS_ASCII ascData = new SECS_ASCII();
                            ...
                            data.Code = TableCode.REAL;
                            data.DataName = "PPACTION";
                            data.ParamMap.SetParameter("RCVPPID", PPData.Data);
                            data.ParamMap.SetParameter("PKGItemData", pkgItemList);
                            data = OnDataExchangeEvent(EventType.WRITE, data);
                            int iRet = data.RetData.ToInt();
                            ...
                            SECS_BINARY bData = new SECS_BINARY(0);
                            SECSEngine.EncodeDataItem(ref sb, bData);
                            SECSEngine.ReplyHSMSMessage(7, 24, false, sb.ToArray(), pEventData.ulSystemBytes);
                        }
                    }
                    break;
                case 25: //Fortmated Process Program Request
                    {
                        if (OnDataExchangeEvent != null)
                        {
                            ...
                            if (iRet == 0) //Not Existed
                            {
                                ...
                                SECS_LIST lstData = new SECS_LIST(0);
                                SECSEngine.EncodeDataItem(ref sb, lstData);
                                SECSEngine.ReplyHSMSMessage(7, 26, false, sb.ToArray(), pEventData.ulSystemBytes);
                            }
                            else
                            {
                                //Load selected package to PreloadPackageDS
                ...
                case 26: //Formatted Process Program Data
                    {
                        if (OnDataExchangeEvent != null)
                        {
                            ...
                            data.Code = TableCode.REAL;
                            data.DataName = "PPACTION";
                            data.ParamMap.SetParameter("RCVPPID", strPPID);
                            data.ParamMap.SetParameter("PKGItemData", pkgItemList);
                            data = OnDataExchangeEvent(EventType.WRITE, data);
                            int iRet = data.RetData.ToInt();
                        }
        ...
        private void ProcessSType_10(EventData pEventData)
        {
            switch (pEventData.F)
            {
                case 3: //S10F3 Terminal Display, Single
                    {
                        ...
                        TerminalServiceDisplay(TEXT.Data, pEventData, false);
                    }
                    break;
                case 5: //S10F5 Terminal Display, Multi
                    {
                        ...
                        TerminalServiceDisplay(strDisp, pEventData, true);
                    }
                    break;
                #region S9,F5 Unrecognized Function Type
                default:
        ...
        private void ProcessSType_14(EventData pEventData)
        {
            switch (pEventData.F)
            {
        ...
        private void TerminalServiceDisplay(String strContent, EventData pEventData, bool bIsMultiMsg = false)
        {
            ...
            if (bIsMultiMsg)
            {
                SECSEngine.ReplyHSMSMessage(10, 6, false, sb.ToArray(), pEventData.ulSystemBytes);
            }
            else
            {
                SECSEngine.ReplyHSMSMessage(10, 4, false, sb.ToArray(), pEventData.ulSystemBytes);
            }
        }
        ...
        public void OnlineModeChange(string Mode)
        {
            switch (Mode)
            {
                case "Local":
                    ControlMode_OnClick(btnLocal, null);
                    break;
                case "Remote":
                    ControlMode_OnClick(btnRemote, null);
                    break;
            }
        }
        ExchangeData WriteECIDData(ExchangeData exData)
        {
            switch (exData.DataName)
            {
                case "DeviceID":
                    {
                        ...
                        if (ecData != null)
                        {
                            if (exData.ParamMap.IsParameterExisted("P1"))
                            {
                                ...
                                ecData.Value = new SECS_U2(setVal);
                ...
                case "IP":
                    {
                        ...
                        if (ecData != null)
                        {
                            if (exData.ParamMap.IsParameterExisted("P1"))
                            {
                                string setVal = (string)exData.ParamMap.GetParameter("P1");
                                ecData.Value = new SECS_ASCII(setVal);
                                exData.RetData = new DataTransfer(0); //= 0 表示可設定並完成； != 0 表示不可改變或無法改變
                            }
                            else
                            {
                ...
                case "InitCommState":
                    {
                        ECData ecData = ECList.Find(x => x.Name == "InitCommState");
                        if (ecData != null)
                        {
                            if (exData.ParamMap.IsParameterExisted("P1"))
                            {
                ...
                case "InitControlState":
                    {
                        ECData ecData = ECList.Find(x => x.Name == "InitControlState");
                        if (ecData != null)
                        {
                            if (exData.ParamMap.IsParameterExisted("P1"))
                            {
                    ...
                    break;
                case "OfflineSubState":
                    {
                        ECData ecData = ECList.Find(x => x.Name == "OfflineSubState");
                        if (ecData != null)
                        {
                            if (exData.ParamMap.IsParameterExisted("P1"))
                            {
                ...
                case "OnlineSubState":
                    {
                        ECData ecData = ECList.Find(x => x.Name == "OnlineSubState");
                        if (ecData != null)
                        {
                            if (exData.ParamMap.IsParameterExisted("P1"))
                            {
                ...
                case "MaxSpoolTransmit":
                    {
                        ...
                        if (ecData != null)
                        {
                            if (exData.ParamMap.IsParameterExisted("P1"))
                            {
                                int setVal = (int)exData.ParamMap.GetParameter("P1");
                                ecData.Value = new SECS_I4(setVal);
                                exData.RetData = new DataTransfer(0); //= 0 表示可設定並完成； != 0 表示不可改變或無法改變
                            }
                            else
                            {
                ...
                case "OverWriteSpool":
                    {
                        ...
                        if (ecData != null)
                        {
                            if (exData.ParamMap.IsParameterExisted("P1"))
                            {
                                bool setVal = (bool)exData.ParamMap.GetParameter("P1");
                                ecData.Value = new SECS_BOOLEAN(setVal);
                                exData.RetData = new DataTransfer(0); //= 0 表示可設定並完成； != 0 表示不可改變或無法改變
                            }
                            else
                            {
                ...
                case "MachineID":
                    {
                        ECData ecData = ECList.Find(x => x.Name == "MachineID");
                        if (ecData != null)
                        {
                            if (exData.ParamMap.IsParameterExisted("P1"))
                            {
                ...
                case "ActiveConnect":
                    {
                        ECData ecData = ECList.Find(x => x.Name == "ActiveConnect");
                        if (ecData != null)
                        {
                            if (exData.ParamMap.IsParameterExisted("P1"))
                            {
        ...
        private void WriteProVXls(TableCode tc, string DataName, object data)
        {
            switch (tc)
            {
                case TableCode.ECID:
                    {
                        String str = SYSPara.SysDir + @"\Localdata";
                        String SECSConfigFile = str + "\\ProVSECS.xls";
                        if (File.Exists(SECSConfigFile))
                        {
                            using (FileStream fs = new FileStream(SECSConfigFile, FileMode.Open, FileAccess.ReadWrite))
                            {
                                HSSFWorkbook workbook = new HSSFWorkbook(fs);
                                //CEID Table
                                HSSFSheet sheetCEID = (HSSFSheet)workbook.GetSheet("ECID");

                                for (int j = 0; j <= sheetCEID.LastRowNum; j++)
                                {
                                    HSSFRow row = (HSSFRow)sheetCEID.GetRow(j);
                                    if (row.GetCell(1).ToString() == DataName)
                                    {
                                        SetCellValue(row.GetCell(4), data);
                                        FileStream fsw = File.OpenWrite(SECSConfigFile);
                                        workbook.Write(fsw);
                                        fsw.Close();
                                        break;
        ...
        //+ By Max, PPBODY Operation
        /// <summary>
        /// 掃描以及建立ProVGemF所需用到的PPBody的Excel檔案
        /// </summary>
        /// <param name="ppDS">Package的資料管理元件</param>
        public void ScanAndCreatePPBody(DataManagement ppDS)
        {
            if (ppDS.FieldList.Count == 0)
            {
                MessageBox.Show("請先載入料號後再執行此操作！", "訊息", MessageBoxButtons.OK, MessageBoxIcon.Information);
                return;
            }

            String str = SYSPara.SysDir + @"\Localdata";
            String SECSPPBodyFile = str + "\\PPBody.xls";
            int index = 0;

            //如果已有舊的檔案，則先刪除
            if (File.Exists(SECSPPBodyFile))
                File.Delete(SECSPPBodyFile);

            try
            {
                using (FileStream fs = new FileStream(SECSPPBodyFile, FileMode.CreateNew, FileAccess.Write))
                {
                    //建立Excel 2003檔案
                    IWorkbook workbook = new HSSFWorkbook();

                    //#region 建立PPBODY資料
                    ISheet sheet = workbook.CreateSheet("PPBODY");
                    int LineCNT = 0;
                    //寫入模組表頭
                    ...
                    index = 0;
                    sheet.GetRow(LineCNT).CreateCell(index++).SetCellValue("ItemName");
                    sheet.GetRow(LineCNT).CreateCell(index++).SetCellValue("Format");
                    sheet.GetRow(LineCNT).CreateCell(index++).SetCellValue("DataName");
                    ...
                    //使用HashSet以排除重複紀錄
                    HashSet<String> FieldDataSet = new HashSet<string>();
                    foreach (DataManagement.FieldData fData in ppDS.FieldList)
                    {
                        switch (fData.Type)
                        {
                            case "String":
                            case "Table":
                                {
                                    bool bNeedAdded = FieldDataSet.Add(fData.DataName);
                                    if (bNeedAdded)
                                    {
                                        sheet.CreateRow(LineCNT);
                                        sheet.GetRow(LineCNT).CreateCell(0).SetCellValue(fData.DataName);
                                        sheet.GetRow(LineCNT).CreateCell(1).SetCellValue("A");
                                        sheet.GetRow(LineCNT).CreateCell(2).SetCellValue(fData.DataName);
                                        foreach (HSSFCell cell in sheet.GetRow(LineCNT).Cells)
                                            cell.CellStyle = cs1;
                                        LineCNT++;
                                    }
                            ...
                            case "SubPackage":
                                {
                                    String strPreFix = fData.DataName;
                                    ...
                                    foreach (DataManagement.FieldData fSubData in fData.SubPackage.FieldList)
                                    {
                                        FieldDataSet.Add(fSubData.DataName);
                                        sheet.CreateRow(LineCNT);
                                        switch (fSubData.Type)
                                        {
                                            case "String":
                                            case "Table":
                                                {
                                                    sheet.GetRow(LineCNT).CreateCell(0).SetCellValue(String.Format("{0}.{1}", strPreFix, fSubData.DataName));
                                                    sheet.GetRow(LineCNT).CreateCell(1).SetCellValue("A");
                                                    sheet.GetRow(LineCNT).CreateCell(2).SetCellValue(String.Format("{0}.{1}", strPreFix, fSubData.DataName));
                                                }
                                                break;
                                            case "Int":
                                                {
                                                    sheet.GetRow(LineCNT).CreateCell(0).SetCellValue(String.Format("{0}.{1}", strPreFix, fSubData.DataName));
                                                    sheet.GetRow(LineCNT).CreateCell(1).SetCellValue("I4");
                                                    sheet.GetRow(LineCNT).CreateCell(2).SetCellValue(String.Format("{0}.{1}", strPreFix, fSubData.DataName));
                                                }
                                                break;
                                            case "Double":
                                                {
                                                    sheet.GetRow(LineCNT).CreateCell(0).SetCellValue(String.Format("{0}.{1}", strPreFix, fSubData.DataName));
                                                    sheet.GetRow(LineCNT).CreateCell(1).SetCellValue("F8");
                                                    sheet.GetRow(LineCNT).CreateCell(2).SetCellValue(String.Format("{0}.{1}", strPreFix, fSubData.DataName));
                                                }
                                                break;
                                            case "Boolean":
                                                {
                                                    sheet.GetRow(LineCNT).CreateCell(0).SetCellValue(String.Format("{0}.{1}", strPreFix, fSubData.DataName));
                                                    sheet.GetRow(LineCNT).CreateCell(1).SetCellValue("BOOL");
                                                    sheet.GetRow(LineCNT).CreateCell(2).SetCellValue(String.Format("{0}.{1}", strPreFix, fSubData.DataName));
                                                }
                                                break;
                                        }
        ...
        //+ By Max, Create AlarmList.xls 
        /// <summary>
        /// 掃描以及建立AlarmList Excel檔案
        /// </summary>
        /// <param name="ppDS">Alarm Table 總表</param>
        public void ScanAndCreateAlarmList(List<ArmMtrl> armList)
        {
            String str = SYSPara.SysDir + @"\Localdata";
            String SECSAlarmListFile = str + "\\AlarmList.xls";
            String tempAlarmListFile = str + "\\AlarmListTemp.xls";
            int index = 0;

            try
            {
                //如果已有舊的檔案，則直接讀取使用
                if (File.Exists(SECSAlarmListFile))
                {
                    File.Copy(SECSAlarmListFile, tempAlarmListFile, true);

                    using (FileStream fsArm = new FileStream(tempAlarmListFile, FileMode.Open, FileAccess.Read))
                    {
                        HSSFWorkbook wbArmList = new HSSFWorkbook(fsArm);

                        HSSFSheet sheet = (HSSFSheet)wbArmList.GetSheet("ALARMLIST");

                        for (int j = 0; j <= sheet.LastRowNum; j++)
                        {
                            HSSFRow row = (HSSFRow)sheet.GetRow(j);
                            if ((row.GetCell(0) != null) && (row.GetCell(0).ToString() == "Type")) //Header Row
                                continue;
                            else
                            {
                                if (!IsCellNullorEmpty(row, 0) ||
                                    ...
                                    )
                                {
                                    ...
                                    String ALText = row.GetCell(3).ToString();
                                    ArmList.Add(new ALMData(0x02, ALText, Convert.ToUInt16(ID), 0x80));
                                }
                                else
                                {
                                    continue;
                    ...
                    File.Delete(tempAlarmListFile);
                }
                else
                {
                    using (FileStream fs = new FileStream(SECSAlarmListFile, FileMode.CreateNew, FileAccess.Write))
                    {
                        //建立Excel 2003檔案
                        IWorkbook workbook = new HSSFWorkbook();

                        //#region 建立PPBODY資料
                        ISheet sheet = workbook.CreateSheet("ALARMLIST");
                        int LineCNT = 0;
                        //寫入模組表頭
                        sheet.CreateRow(LineCNT);
                        HSSFCellStyle cs = (HSSFCellStyle)workbook.CreateCellStyle();
                        ...
                        index = 0;
                        sheet.GetRow(LineCNT).CreateCell(index++).SetCellValue("Type");
                        sheet.GetRow(LineCNT).CreateCell(index++).SetCellValue("ID");
                        sheet.GetRow(LineCNT).CreateCell(index++).SetCellValue("TW");
                        sheet.GetRow(LineCNT).CreateCell(index++).SetCellValue("EN");
                        ...
                        foreach (ArmMtrl armData in armList)
                        {
                            if (armData.AlarmLevel == "E" || armData.AlarmLevel == "e")
                            {
                                sheet.CreateRow(LineCNT);
                                sheet.GetRow(LineCNT).CreateCell(0).SetCellValue(armData.AlarmLevel);
                                String strErrCode = "0000";
                                if (armData.ModuleID == 0) //Kernal, Main and MainFlow
                                {
                                    strErrCode = String.Format("{0:0000}", armData.ErrorCode);
                                }
                                else //Module
                                {
                                    strErrCode = String.Format("{0:00}{1:00}", armData.ModuleID, armData.ErrorCode);
                                }
                                sheet.GetRow(LineCNT).CreateCell(1).SetCellValue(strErrCode);
                                sheet.GetRow(LineCNT).CreateCell(2).SetCellValue(armData.LanCHT.Explain);
                                sheet.GetRow(LineCNT).CreateCell(3).SetCellValue(armData.LanENG.Explain);
                                foreach (HSSFCell cell in sheet.GetRow(LineCNT).Cells)
                                    cell.CellStyle = cs1;
                                LineCNT++;

                                ArmList.Add(new ALMData(0x02, armData.LanENG.Explain, Convert.ToUInt16(strErrCode), 0x80));
                            }
                        }
